...
class TicktickAPI:
    ...
    def login(self, user: str, password: str) -> str:
        ...
        response = self.post(self.SIGNIN_URL, return_json=False, data=payload, token_required=False)
    ...
    def post(self, url: str, data: Optional[dict] = None, token_required: bool = True, return_json: bool = True) \
            -> Response | dict:
        ...
        Args:
            ...
            data: Data to send in the request. Defaults to None.
            token_required: Whether the request requires an authentication token. Defaults to True.
            return_json: Whether to return the response as a JSON or as a Response object. Defaults to True.
    ...
    @overload
    def get(self, url: str, return_json: Literal[True], data: Optional[dict] = None, token_required: bool = True)\
            -> dict:
        ...

    @overload
    def get(self, url: str, return_json: Literal[False], data: Optional[dict] = None, token_required: bool = True)\
            -> Response:
        ...

    def get(self, url: str, return_json: bool = True, data: Optional[dict] = None, token_required: bool = True) \
            -> Response | dict:
